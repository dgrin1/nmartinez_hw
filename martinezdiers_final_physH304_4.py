...
#Realistic artery segment size (thinner), normal blood density, more viscous blood
L = 0.05
w = 0.015 #artery diameter
dt = 0.00000005
...
rho = 1060 #normal
nu = 0.005528 #higher end of normal
a = 8.6e-5 #u_in, slower end of normal
P = 10
