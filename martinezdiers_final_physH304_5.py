...
#Realistic artery segment size (thicker), more dense, less viscous blood
L = 0.05
w = 0.025 #artery diameter
dt = 0.00000005
...
#0.0035 - 0.0055
rho = 2000 #higher than normal density
nu = 0.003528 #low end of normal viscosity
a = 2.8e-4 #u_in, high end of norma1
P = 10
...
for nt in [100,500,1000,1500,2000]:
    ...
    pyplot.title('Iteration number '+str(nt)+' with Re = '+str(Re))
    pyplot.show()