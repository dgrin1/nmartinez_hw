...
#Huge artery size (unrealistic), very very fast incoming velocity, way less viscous (out of normal range), high density (out of normal range), high external forces (proxy for high reynolds number) 
L = 2
w = 1
dt = 0.00001
